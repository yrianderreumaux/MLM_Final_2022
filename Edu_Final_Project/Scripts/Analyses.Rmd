...
df <- read.csv("/Volumes/GoogleDrive/.shortcut-targets-by-id/1a3bpVLXtKTU5gNIvNj9MJBoD3mAGzzK2/Preference Falsification/Analysis/output/PFfullDF.csv")
```
...
```{r}
M1 <-  clmm(as.factor(eval) ~ Info * scale(inMinOut) +(1|subID) + (1|issues), data = df, threshold = "flexible")
summary(M1)
